...
PERM_GATED = {
    ...
    "censor": discord.Permissions(manage_guild=True),
    "linkspam": discord.Permissions(manage_guild=True),
    "ar": discord.Permissions(manage_guild=True),
    "form": discord.Permissions(manage_guild=True),
    "relay": discord.Permissions(manage_guild=True),
    "welcome": discord.Permissions(manage_guild=True),
    "ask": discord.Permissions(manage_guild=True),
    "disable": discord.Permissions(manage_guild=True),
    "enable": discord.Permissions(manage_guild=True),
    "ignore": discord.Permissions(manage_guild=True),
    "unignore": discord.Permissions(manage_guild=True),
    "modrole": discord.Permissions(manage_guild=True),
    "unmodrole": discord.Permissions(manage_guild=True),
    "stop": discord.Permissions(manage_guild=True),
    "purgex": MOD_PERMS,
    "sticky": MOD_PERMS,
    "rr": discord.Permissions(manage_roles=True),
    "autorole": discord.Permissions(manage_roles=True),
    "role": discord.Permissions(manage_roles=True),
    "addrank": discord.Permissions(manage_roles=True),
    "removerank": discord.Permissions(manage_roles=True),
    "approve": MOD_PERMS,
    "deny": MOD_PERMS,
    "consider": MOD_PERMS,
    "implemented": MOD_PERMS,
}
