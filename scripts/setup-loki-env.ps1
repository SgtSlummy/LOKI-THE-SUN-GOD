...
$schema = @(
    ...
    @{ Key = "RAILWAY_TOKEN"; Label = "Optional Railway project token for project-scoped CLI helpers"; Required = $false; Secret = $true; Default = "" },
    @{ Key = "RAILWAY_API_TOKEN"; Label = "Optional Railway account/workspace API token for CLI helpers"; Required = $false; Secret = $true; Default = "" },
