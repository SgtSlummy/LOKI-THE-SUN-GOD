...
- `loki_research`: public Diva catalog, recommendation scaffolding, V4-V7 packet compiler, V8 Hermes integration manifest, hard-coded bot assembly plan, final product blueprint, and complete package manifest.
