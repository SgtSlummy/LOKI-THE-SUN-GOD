...
- Model deployment modes: `hosted API model`, `local GPU model worker optional`, `Hermes delegated sub-agent model`.

## Autonomy

- Web crawling: `manual_and_autonomous_full_web_crawl_with_operator_policy`.
...
- `P0`: Foundation and hosted Discord core.
- `P1`: Console dashboard and admin LLM controls.
- `P2`: Camelot memory and member intelligence.
- `P3`: Media processing and generation.
- `P4`: Autonomous search, crawl, and recommendation.
- `P5`: Desktop .exe and local GPU workers.
- `P6`: Autonomous evolution with operator governance.
